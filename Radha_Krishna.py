...
#Following code will draw Krishna's hairs style
t1.right(160)
t1.circle(20,100)
t1.forward(10)
t1.circle(-20,25)
...
#We will continue to draw rest part 
t1.right(135)
t1.circle(60,15)
t1.left(70)
t1.forward(6)
...
#We will now start to draw Fluet
t1.right(85)
t1.forward(40)
t1.right(60)
t1.circle(5,310)
...
#We will draw the rest part of Fluet
t1.right(90)
t1.forward(34)
t1.right(85)
...
#Now, we will draw Krishna's dress
t1.right(80)
t1.circle(10,40)
t1.forward(45)
t1.left(10)
...
t1.forward(260)
t1.end_fill()
#At this point, we have completed drawing Radha Krishna
